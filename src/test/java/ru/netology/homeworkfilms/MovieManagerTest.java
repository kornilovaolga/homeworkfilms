...
class MovieManagerTest {
    ...
    @Test
    void shouldRevertMovies() {
        MovieData[] returned = new MovieData[]{movieOne, movieTwo, movieThree};
        doReturn(returned).when(repository).getMovies();

        MovieData[] expected = new MovieData[]{movieThree, movieTwo, movieOne};
        manager.revertMovies();
    ...
    void shouldAddMovie() {
        ...
        MovieData[] expected = new MovieData[]{movieOne, movieTwo, movieThree, movieFour};
        manager.addMovie(movieFour);
        MovieData[] actual = manager.getMovies();
